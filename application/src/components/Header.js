    ...
    <div className="relative bg-white overflow-hidden">
              ...
              >
                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <a href="#">
                      <span className="sr-only">한국외대문학회</span>
                      <img
                        className="h-10 w-auto sm:h-20"
                        // 모바일의 경우 크면 더 유저 경험 면에서 휑한 느낌이 없을 듯 하여 sm을 더 크게 설정
                        src="https://static4.depositphotos.com/1029305/388/v/380/depositphotos_3882728-stock-illustration-line-art-black-pen.jpg?forcejpeg=true"
                      />
                    </a>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          src="https://gsssh.ku.edu.tr/wp-content/uploads/2020/01/slider.jpg"
          alt=""
        />
      </div>
    </div>
